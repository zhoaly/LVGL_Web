...
typedef enum {
    ...
    APP_UI_THEME_COLOR_SURFACE_MUTED,
    APP_UI_THEME_COLOR_WARNING,
    APP_UI_THEME_COLOR_CONTROL_BACKGROUND,
    APP_UI_THEME_COLOR_CONTROL_FOREGROUND,
    APP_UI_THEME_COLOR_CONTROL_PRESSED,
    APP_UI_THEME_COLOR_FOCUS_BORDER,
