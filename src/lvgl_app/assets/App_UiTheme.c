...
lv_color_t App_UiTheme_GetColor(app_ui_theme_color_id_t id)
{
    static const uint32_t colors[APP_UI_THEME_COLOR_COUNT] = {
        ...
        [APP_UI_THEME_COLOR_CONTROL_BACKGROUND] = 0x111111,
        [APP_UI_THEME_COLOR_CONTROL_FOREGROUND] = 0xFFFFFF,
        [APP_UI_THEME_COLOR_CONTROL_PRESSED] = 0x2D3748,
        [APP_UI_THEME_COLOR_FOCUS_BORDER] = 0xA0AEC0,
