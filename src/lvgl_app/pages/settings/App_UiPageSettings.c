/**
 * @file App_UiPageSettings.c
 * @brief Settings 菜单跳转测试页面。
 */
...
static void build(lv_obj_t *parent, const app_ui_model_t *model)
{
    ...
    lv_image_set_src(icon, App_UiAssets_GetIcon(APP_UI_ICON_MENU_SETTINGS));
    ...
    lv_label_set_text(description, "Device preferences");
